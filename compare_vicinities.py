...
V3 = [(4, 2, 0.3), (2, 3.3, -2), (-2, 1, 1), (-4, 0, 1)]
...
print("This is the overall_pair_score of V3 and V4")
print(overall_pair_score(M2))

# compute total pairing score for vicinities 1 and 2
M1 = (vicinities_matrix(V1, V2))
print("This is the overall_pair_score of V1 and V2")
print(overall_pair_score(M1))
'''
